                                        ...
                                        <div class="ibox-content text-dark">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:TextBox runat="server" ID="tbHospitalName" class="form-control mt-2" Text="Demo Hospital" disabled></asp:TextBox>
                                                </div>
                                                <div class="col-md-3">
                                                    <span class="form-label fw-semibold">Type</span>
                                                    <asp:TextBox runat="server" ID="tbType" class="form-control mt-2" Text="Private" disabled></asp:TextBox>
                                                </div>
                                                <div class="col-md-3">
                                                    <span class="form-label fw-semibold">Address</span>
                                                    <asp:TextBox runat="server" ID="tbAddress" class="form-control mt-2" Text="Ranchi, Jharkhand" disabled></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <asp:DropDownList ID="dlAction" runat="server" class="form-control mt-2">
                                                    <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="Approve" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="Reject" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="Raise Query" Value="3"></asp:ListItem>
                                                    <asp:ListItem Text="Assign" Value="4"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <span class="form-label fw-semibold">Select User Role</span>
                                                <asp:DropDownList ID="dlUserRole" runat="server" class="form-control mt-2">
                                                    <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <span class="form-label fw-semibold">Select User To Assign</span>
                                                <asp:DropDownList ID="dlUserToAssign" runat="server" class="form-control mt-2">
                                                    <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 mb-3">
