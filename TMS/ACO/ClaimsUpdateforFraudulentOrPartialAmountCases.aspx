<%@ Page Title="" Language="C#" MasterPageFile="~/ACO/ACO.master" AutoEventWireup="true" CodeFile="ClaimsUpdateforFraudulentOrPartialAmountCases.aspx.cs" Inherits="ACO_ClaimsUpdateforFraudulentOrPartialAmountCases" %>
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                <h4 class="m-0">Claims Update for Fraudulent/Partial Amount Cases</h4>
            </div>
