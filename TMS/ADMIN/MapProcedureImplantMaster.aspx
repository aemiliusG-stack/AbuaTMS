<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.master" AutoEventWireup="true" CodeFile="MapProcedureImplantMaster.aspx.cs" Inherits="ADMIN_MapProcedureImplantMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <contenttemplate>
            ...
            <asp:HiddenField ID="hdProcedureImplantId" runat="server" Visible="false" />
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="ibox-content text-dark">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <asp:DropDownList ID="dropImplantCode" runat="server" class="form-control" Style="margin-top: 2%;" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-2">
                                <asp:GridView ID="gridMapProcedureImplant" runat="server" AllowPaging="True" OnPageIndexChanging="gridMapProcedureImplant_PageIndexChanging" OnRowDataBound="gridMapProcedureImplant_RowDataBound" PageSize="10" AutoGenerateColumns="False" Width="100%" CssClass="table table-bordered table-striped">
                                    ...
                                    <columns>
                                        ...
                                        <asp:TemplateField HeaderText="Implant Code">
                                            <itemtemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <itemtemplate>
                                                <asp:Label ID="lbProcedureImplantId" runat="server" Text='<%# Eval("ProcedureImplantId") %>' Visible="false"></asp:Label>
