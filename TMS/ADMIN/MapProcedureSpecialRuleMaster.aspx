<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.master" AutoEventWireup="true" CodeFile="MapProcedureSpecialRuleMaster.aspx.cs" Inherits="ADMIN_MapProcedureSpecialRuleMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <contenttemplate>
            ...
            <asp:HiddenField ID="hdProcedureSpecialId" runat="server" Visible="false" />
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-title text-center">
                        <h3 class="text-white">Map Procedure Special Rule</h3>
                    </div>
                        ...
                        <div class="ibox">
                            <div class="ibox-content text-dark">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <span class="form-label fw-semibold">Rule Description</span>
                                        <asp:TextBox runat="server" ID="tbRuleDescription" class="form-control mt-2" OnKeypress="return isAlphaNumeric(event)"></asp:TextBox>
                                    </div>
                                ...
                                <asp:GridView ID="gridSpecialRule" runat="server" AllowPaging="True" OnPageIndexChanging="gridSpecialRule_PageIndexChanging" OnRowDataBound="gridSpecialRule_RowDataBound" PageSize="10" AutoGenerateColumns="False" Width="100%" CssClass="table table-bordered table-striped">
                                    ...
                                    <columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rule Description">
                                            <itemtemplate>
                                                <asp:Label ID="lbRuleDescription" runat="server" Text='<%# Eval("RuleDescription") %>'></asp:Label>
                                            </itemtemplate>
                                            <headerstyle backcolor="#1E8C86" font-bold="True" forecolor="White" />
