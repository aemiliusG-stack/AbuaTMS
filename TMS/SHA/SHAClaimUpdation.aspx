                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                            ...
                            <div class="table-responsive mt-2">
                                <asp:GridView ID="gridCases" runat="server" AllowPaging="True" OnRowDataBound="gridCases_RowDataBound" OnPageIndexChanging="gridCases_PageIndexChanging" PageSize="10" AutoGenerateColumns="False" Width="115%" CssClass="table table-bordered table-striped">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl. No.">
                                            ...
                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="item-center" />
                                            <ItemStyle CssClass="item-center" Width="5%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Claim Initiate Amount(Rs.)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="TDS Amount(Insurer)">
                                            ...
                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="item-center" />
                                            <ItemStyle Width="5%" CssClass="item-center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="BFA Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lbBfaAmount" runat="server" Text="0.0"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="item-center" />
                                            <ItemStyle Width="5%" CssClass="item-center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Claim Payable Amount(Rs.)">
                                            <ItemTemplate>
                                                <asp:Label ID="lbClaimPayableAmount" runat="server" Text=""></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="item-center" />
                                            <ItemStyle Width="5%" CssClass="item-center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="SHA Exemption Remarks">
                                            <ItemTemplate>
                                                <asp:TextBox TextMode="MultiLine" runat="server" ID="tbShaRemarks" class="form-control mt-2" OnKeypress="return isAlphaNumeric(event)"></asp:TextBox>
                                            </ItemTemplate>
                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="item-center" />
                                            <ItemStyle Width="5%" CssClass="item-center" />
                                        </asp:TemplateField>
