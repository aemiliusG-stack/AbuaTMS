                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3 mt-3">
                                                            ...
                                                            <asp:Label ID="lbRegNo" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="col-md-3 mt-3">
                                                        ...
                                                        <div class="col-md-3 mt-3">
                                                            <span class="font-weight-bold">Actual Registration Date:</span><br />
                                                        ...
                                                        <div class="col-md-3 mb-3 mt-3">
                                                            <span class="font-weight-bold">New Born Baby Case:</span><br />
                                                            <asp:Label ID="lbIsChild" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="col-md-3 mt-3">
                                                        ...
                                                        <div class="col-md-3 mb-3 mt-3">
                                                            ...
                                                            <asp:Label ID="lbBiometricVerified" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="col-md-3 mt-3">
                            ...
                            <ul class="nav nav-tabs" id="mytabs" role="tablist">
                                ...
                                <li class="nav-item ml-3" id="listTreatment" runat="server">
                                ...
                                <li class="nav-item ml-3" id="listClaims" runat="server">
                                ...
                                <li class="nav-item ml-3">
                                    <asp:Button ID="btnCaseSheet" runat="server" Text="Case Sheet" OnClick="btnCaseSheet_Click" Style="padding: 1rem;" class="nav-link d-flex flex-column align-items-center" />
                                </li>
                                <li class="nav-item ml-3">
                            ...
                            <div class="tab-content mt-4" id="myTabContent">
                                <asp:MultiView ID="mvCPDTabs" runat="server">
                                    ...
                                    <asp:View ID="ViewPreauth" runat="server">
                                        <asp:Panel ID="pPrauthorizationTab" runat="server">
                                            <div class="tab-pane fade show active" id="preauth" role="tabpanel">
                                                <div class="ibox">
                                                    ...
                                                    <div class="ibox-content">
                                                        <div class="ibox-content text-dark">
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <span class="font-weight-bold text-dark">Hospital Name</span>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <span class="font-weight-bold text-dark">Type</span>
                                                ...
                                                <div class="ibox mt-4">
                                                    ...
                                                    <asp:Panel ID="pPreauthPD" runat="server">
                                                        <div class="ibox-content">
                                                            <div class="ibox mt-4">
                                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                    ...
                                                    <asp:Panel ID="pPreauthSD" runat="server" Visible="false">
                                                        <div class="ibox-content">
                                                            <div class="ibox mt-4">
                                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                    ...
                                    <asp:View ID="ViewTreatmentDischarge" runat="server">
                                        <asp:Panel ID="pTreatmentDischarge" runat="server">
                                            <div class="tab-pane fade show active" id="treatmentdischarge" role="tabpanel">
                                                ...
                                                <div class="ibox ">
                                                    <div class="ibox-title d-flex justify-content-center">
                                                        <h5 style="text-align: center;">Surgery/Treatment Start Date Details</h5>
                                                                ...
                                                                <asp:GridView ID="gridSurgeryTreatmentDate" runat="server" AutoGenerateColumns="False" BackColor="White" AllowPaging="True" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%" CssClass="table table-bordered table-striped">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Surgery Date/Treatment Start Date">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbActionName" runat="server" Text='<%# Eval("TreatmentStartDate") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" />
                                                                        </asp:TemplateField>
                                    ...
                                    <asp:View ID="ViewClaims" runat="server">
                                        <asp:Panel ID="pClaims" runat="server">
                                            <div class="tab-pane fade show active" id="claims" role="tabpanel">
                                                        ...
                                                        <div class="ibox-content text-dark">
                                                            <div class="col-lg-12">
                                                                <div class="form-group row m-b">
                                                                    <div class="col-md-4">
                                                                        <span class="font-weight-bold text-dark">Total Claims (Rs):</span><br />
                                                                    ...
                                                                    <asp:Panel ID="pInsuranceApprovedAmt" runat="server" Visible="false">
                                                                        <div class="col-md-4">
                                                                            <span class="font-weight-bold text-dark" style="white-space: nowrap;">Insurance Approved Amount (Rs)<span class="text-danger">*</span>:</span><br />
                                                                    ...
                                                                    <asp:Panel ID="pTrustApprovedAmt" runat="server" Visible="false">
                                                                        <div class="col-md-4">
                                                                            <span class="font-weight-bold text-dark" style="white-space: nowrap;">Trust Approved Amount (Rs)<span class="text-danger">*</span>:</span><br />
                                                                ...
                                                                <div class="form-group row mb-3">
                                                                    <div class="col-md-4 pt-3">
                                                                        <span class="font-weight-bold text-dark">Special Case:</span><br />
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        <span class="font-weight-bold text-dark">1) Diagnosis is Supported by Evidence</span><span class="text-danger">*</span><br />
                                                                    </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        <span class="font-weight-bold text-dark">2) Case Management Proven to be done as per the Standard Treatment Protocols</span><span class="text-danger">*</span><br />
                                                                    </div>
                                                                    <div class="col text-right">
                                                                        <div class="form-check form-check-inline mt-2">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        <span class="font-weight-bold text-dark">3) Evidence of the Therapy being Conducted exists beyond Doubts</span><span class="text-danger">*</span><br />
                                                                    </div>
                                                                    <div class="col text-right">
                                                                        <div class="form-check form-check-inline mt-2">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        <span class="font-weight-bold text-dark">4) Mandatory Reports are Attached</span><span class="text-danger">*</span><br />
                                                                    </div>
                                                                    <div class="col text-right">
                                                                        <div class="form-check form-check-inline mt-2">
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    <div class="form-group">
                                                                        <span class="font-weight-bold text-dark">Remarks</span>
                                                                        <asp:TextBox ID="tbTechRemarks" runat="server" Enabled="false" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <asp:Panel ID="pnlAddDeduction" runat="server" Visible="false">
                                                    <div class="ibox mt-4">
                                                        <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                            <div class="d-flex w-100 justify-content-center position-relative">
                                                        ...
                                                        <div class="ibox-content">
                                                            <div class="row">
                                                                <div class="table-responsive">
                                                                    <asp:GridView ID="gvDeduction" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Both" Width="100%">
                                                                        <AlternatingRowStyle BackColor="Gainsboro" />
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="S.No.">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDSlNo" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Role Name">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDRoleName" runat="server" Text='<%# Eval("RoleName") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15%" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Deduction Type">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDDeductionType" runat="server" Text='<%# Eval("DeductionType") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15%" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Deducted Amount">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDDeductedAmt" runat="server" Text='<%# Eval("DeductionAmt") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDTotalAmt" runat="server" Text='<%# Eval("TotalAmtAfterDeduction") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15%" />
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Remarks">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDRemarks" runat="server" Text='<%# Eval("Remarks") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15%" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Deduction Date">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbDDeductionDate" runat="server" Text='<%# Eval("CreatedOn") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" CssClass="text-center" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="20%" />
                                                                            </asp:TemplateField>
                                                ...
                                                <asp:Panel ID="pACORemarks" runat="server" Visible="false">
                                                    <div class="ibox mt-4">
                                                        <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                            <div class="d-flex w-100 justify-content-center position-relative">
                                                ...
                                                <asp:Panel ID="pSHARemarks" runat="server" Visible="false">
                                                    <div class="ibox mt-4">
                                                        <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                            <div class="d-flex w-100 justify-content-center position-relative">
                                                ...
                                                <asp:Panel ID="pPreauthUtilization" runat="server" Visible="false">
                                                ...
                                                <asp:Panel ID="pClaimQuery" runat="server" Visible="false">
                                                    ...
                                                    <div class="ibox mt-4">
                                                        ...
                                                        <div class="ibox-content table-responsive">
                                                            <asp:GridView ID="gvClaimQuery" OnRowDataBound="gvClaimQuery_RowDataBound" runat="server" AutoGenerateColumns="false" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%" CssClass="table table-bordered table-striped">
                                                                <AlternatingRowStyle BackColor="gainsboro" />
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Sl. No.">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Main Reason">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbClaimMainReason" runat="server" Text='<%# Eval("ReasonName") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle BackColor="#1e8c86" Font-Bold="true" ForeColor="white" />
                                                                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" Width="10%" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Sub Reason">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbClaimSubReason" runat="server" Text='<%# Eval("SubReasonName") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle BackColor="#1e8c86" Font-Bold="true" ForeColor="white" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Medco Reply">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbMedcoReplyClaim" runat="server" Text='<%# Eval("QueryReply") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle BackColor="#1e8c86" Font-Bold="true" ForeColor="white" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Audit">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbClaimIsQueryReplied" Visible="false" runat="server" Text='<%# Eval("IsQueryReplied") %>'></asp:Label>
                                                                            <asp:Label ID="lbClaimQueryFolderName" Visible="false" runat="server" Text='<%# Eval("QueryFolderName") %>'></asp:Label>
                                                                            <asp:Label ID="lbClaimQueryUploadedFileName" Visible="false" runat="server" Text='<%# Eval("QueryUploadedFileName") %>'></asp:Label>
                                                                            <asp:Button ID="btnClaimViewAudit" runat="server" Text="Pending" class="btn btn-warning btn-sm rounded-pill" Style="font-size: 12px;" OnClick="btnClaimViewAudit_Click" />
                                                                        </ItemTemplate>
                                                                        <HeaderStyle BackColor="#1e8c86" Font-Bold="true" ForeColor="white" />
                                                                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" Width="10%" />
                                                                    </asp:TemplateField>
                                    ...
                                    <asp:View ID="ViewCaseSheet" runat="server">
                                        <div class="tab-pane fade show active" id="CaseSheet" role="tabpanel">
                                            <%--Patient Details--%>
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                ...
                                                <div class="ibox-content text-dark">
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            <div class="row">
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Health Card Number:</span><br />
                                                                    <asp:Label ID="lbCSBISCardNo" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Patient Name:</span><br>
                                                                    <asp:Label ID="lbCSPatientName" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Age:</span><br>
                                                                    <asp:Label ID="lbCSAge" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Gender:</span><br>
                                                                    <asp:Label ID="lbCSGender" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Phone Number:</span><br>
                                                                    <asp:Label ID="lbCSPhoneNumber" runat="server" Text="N/A"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Communication Contact Number:</span><br>
                                                                    <asp:Label ID="lbCommunicationContactNo" runat="server" Text="N/A"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Address:</span><br>
                                                                    <asp:Label ID="lbCSAddress" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Communication Address:</span><br>
                                                                    <asp:Label ID="lbCSCommunicationAddress" runat="server"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row col-lg-2 ">
                                                            <div class="col-lg-12 align-items-center">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="../images/user_img.jpeg" CssClass="img-fluid mb-3" Style="max-width: 100px; height: 140px;" AlternateText="Patient Photo" />
                                                                <%-- </div>
                                                            <div class="col-lg-6 align-items-center">
                                                                <asp:Image ID="Image2" runat="server" ImageUrl="../images/user_img.jpeg" CssClass="img-fluid mb-3" Style="max-width: 100px; height: 140px;" AlternateText="Patient Photo" />--%>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Addmission Details</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">IP Number:</span><br />
                                                                    <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Addmission Date:</span><br>
                                                                    <asp:Label ID="Label3" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Addmission Type:</span><br>
                                                                    <asp:Label ID="Label4" runat="server"></asp:Label>
                                                                </div>
                                                                <div class="col-md-3 mt-3">
                                                                    <span class="font-weight-bold">Medco Legal Case:</span><br>
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">History of Present Illness</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    NA
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Known Allergies</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    NA
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Habits/Addictions</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    NA
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Past Illness History</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    Others If Any Past Illness - Others Not Found
                                                </div>
                                            </div>
                                            <%--Family History--%>
                                            <div class="ibox">
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">General Examination Finding</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    <div class="row">
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">Height:&nbsp;&nbsp;</span>
                                                            <asp:Label ID="lbHeight" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                        ...
                                                        <div class="form-check col-md-6 mb-2">
                                                            ...
                                                            <asp:Label ID="Label7" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">Pallor:</span>
                                                            <asp:Label ID="Label8" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Cyanosis:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="rbGMalYes" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="rbGMalNo" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Clubbing of Finger/Toes:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="RadioButton1" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="RadioButton2" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Lymphadenopathy:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="RadioButton3" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="RadioButton4" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Edema of Feet:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="RadioButton5" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="RadioButton6" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Malnutrition:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="RadioButton7" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="RadioButton8" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6">
                                                            <span class="font-weight-bold text-dark">Dehydration:&nbsp;&nbsp;</span>
                                                            <asp:RadioButton ID="RadioButton9" runat="server" Enabled="false" GroupName="Mal" Text="Yes" class="font-weight-bold text-dark" />
                                                            <asp:RadioButton ID="RadioButton10" runat="server" Enabled="false" GroupName="Mal" Text="No" class="font-weight-bold text-dark" />
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">Temperature:&nbsp;&nbsp;</span>
                                                            <asp:Label ID="Label15" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">Pulse Rate Per Minute:&nbsp;&nbsp;</span>
                                                            <asp:Label ID="Label16" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">Respiratiopn Rate:&nbsp;&nbsp;</span>
                                                            <asp:Label ID="Label17" runat="server" Text="N/A"></asp:Label>
                                                        </div>
                                                        <div class="form-check col-md-6 mb-2">
                                                            <span class="font-weight-bold text-dark">BP Lt.Arm:&nbsp;&nbsp;</span>
                                            ...
                                            <%--Systemetic Examination Findings--%>
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Systemetic Examination Findings</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    Systemetic Examination Findings Not Found
                                                </div>
                                            </div>
                                            <%--General Investigation Done and Reports--%>
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">General Investigation Done and Reports</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    General Investigation Reports Not Found for this case
                                                </div>
                                            </div>
                                            <%--Final Diagnosis--%>
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Final Diagnosis</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                        <div class="d-flex w-100 justify-content-center position-relative">
                                                            <h3 class="m-0">Primary Diagnosis</h3>
                                                        </div>
                                                    </div>
                                                    N/A
                                                </div>
                                            </div>
                                            <%--Theory/Surgery Details--%>
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Theory/Surgery Details</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr class="table-primary">
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Category Name</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">ICD Category Name</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Procedure Name</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Units</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Special Investigationb</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Remarks</th>
                                                                    <th scope="col" style="background-color: #007e72; color: white;">Treating Doctor</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title d-flex justify-content-between text-white align-items-center">
                                                    <div class="d-flex w-100 justify-content-center position-relative">
                                                        <h3 class="m-0">Daily Vital Chart</h3>
                                                    </div>
                                                </div>
                                                <div class="ibox-content text-dark">
                                                    Vital Chart Not Found
                                                </div>
                                            </div>
                                        </div>
                                    </asp:View>
