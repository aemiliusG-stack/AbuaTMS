...
public partial class CPD_CPDAssignedCasePatientDetails : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (dt != null)
                {
                    ...
                    btnClaims.CssClass = "btn btn-warning"; DateTime registrationDate = Convert.ToDateTime(dt.Rows[0]["RegDate"].ToString().Trim());
    ...
    protected void btnPreauthViewAudit_Click(object sender, EventArgs e)
    {
        try
        {
            Button btn = (Button)sender;
