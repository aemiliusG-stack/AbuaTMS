...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdClaimMode" runat="server" Visible="false" />
                                                        ...
                                                        <div class="table-responsive">
                                                            <asp:GridView ID="gvPreauthWorkFlow" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%" CssClass="table table-bordered table-striped">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Sl No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbSlNoPriauth" runat="server" Text='<%# Container.DataItemIndex+1 %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle Font-Bold="True" ForeColor="White" CssClass="bg-dark-green text-center" />
                                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="5%" />
                                                                    </asp:TemplateField>
                                                    ...
                                                    <div class="row text-dark">
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lbDocType" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Name</span><br />
                                                                <asp:Label ID="lbDoctorName" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Regn No</span><br />
                                                                <asp:Label ID="lbDocRegnNo" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Qualification</span><br />
                                                                <asp:Label ID="lbDocQualification" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Contact No</span><br />
                                                                <asp:Label ID="lbDocContactNo" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row text-dark">
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lbAnaesthetistName" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Regn No</span><br />
                                                                <asp:Label ID="lbAnaesthetistRegNo" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Contact No</span><br />
                                                                <asp:Label ID="lbAnaesthetistContactNo" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row text-dark">
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lbIncisionType" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row text-dark">
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lbTraetmentDate" runat="server" CssClass="d-block w-100 border-bottom p-2"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Surgery Start Time</span><br />
                                                                <asp:TextBox ID="tbSurgeryStartTime" runat="server" TextMode="Time" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <div class="form-group">
                                                                <span class="font-weight-bold text-dark">Surgery End Time</span><br />
                                                                <asp:TextBox ID="tbSurgeryEndTime" runat="server" TextMode="Time" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="Attachments" role="tabpanel" aria-labelledby="contact-tab">
                                            <div class="tab-pane fade show active" id="attachment" role="tabpanel">
                                                <ul class="nav nav-tabs d-flex flex-row" id="attachTab" role="tablist">
                                                    <li class="nav-item">
                                                        <asp:Button ID="btnPreauthorization" runat="server" Text="Preauthorization Document" OnClick="btnlnkPreauthorization_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>
                                                    ...
                                                    <%--<li class="nav-item ml-2">
                                                        <asp:Button ID="btnDeath" runat="server" Text="Death Document" OnClick="btnDeath_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>
                                                    <li class="nav-item ml-2">
                                                        <asp:Button ID="btnClaim" runat="server" Text="Claim Document" OnClick="btnClaim_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>
                                                    <li class="nav-item ml-2">
                                                        <asp:Button ID="btnGenInvestigation" runat="server" Text="General Investigation Document" OnClick="btnGenInvestigation_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>--%>
                                                    <li class="nav-item ml-2">
                                                    ...
                                                    <%--<li class="nav-item ml-2">
                                                        <asp:Button ID="btnFraudDoc" runat="server" Text="Fraud Document" OnClick="btnFraudDoc_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>
                                                    <li class="nav-item ml-2">
                                                        <asp:Button ID="btnAuditDoc" runat="server" Text="Audit Document" OnClick="btnAuditDoc_Click" class="nav-link d-flex flex-column align-items-center" />
                                                    </li>--%>
                                                </ul>
                                                ...
                                                <div class="tab-content" id="attachTabContent">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Uploaded Documents">
                                                                                <ItemTemplate>
                                                                                    <asp:Label Visible="false" ID="lbFolderName" runat="server" Text='<%# Eval("FolderName") %>'></asp:Label>
                                                                                    <asp:Label Visible="false" ID="lbFileName" runat="server" Text='<%# Eval("UploadedFileName") %>'></asp:Label>
                                                                                    <asp:Button ID="btnViewPostInvestigationDocument" runat="server" Text="View Document" class="btn btn-success btn-sm rounded-pill" Style="font-size: 12px;" OnClick="btnViewPostInvestigationDocument_Click" />
                                                                                </ItemTemplate>
                                                                                <HeaderStyle BackColor="#1E8C86" Font-Bold="True" ForeColor="White" />
                                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="10%" />
                                                                            </asp:TemplateField>
                                                    ...
                                                    <div class="col-md-12 mt-2 mb-2">
                                                        <asp:Button ID="btnDownloadPdf" runat="server" Text="Download as one PDF" class="btn btn-success rounded-pill" OnClick="btnDownloadPdf_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
